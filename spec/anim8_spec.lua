...
describe("anim8", function()
  describe("newGrid", function()
    ...
    it("presets borderWidth to 0 if nothing specified", function()
      local g = newGrid(32,32,64,256)
      assert_equal(0, g.borderWidth)
    end)
  end)
